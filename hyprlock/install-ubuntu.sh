...
echo "I did a lot of junk to get it working, and it's pretty annoying since Ubuntu ships with an older GCC than hypr-everything uses. After much struggle I found https://github.com/JaKooLit/Ubuntu-Hyprland/blob/24.04/ which worked immediately"
